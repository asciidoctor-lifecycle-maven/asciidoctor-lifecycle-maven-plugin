...
image:https://api.codacy.com/project/badge/Grade/5b57464da7c24dd4879215c76c7ac257["Codacy code quality", link="https://www.codacy.com/gh/asciidoctor-lifecycle-maven/asciidoctor-lifecycle-maven-plugin?utm_source=github.com&utm_medium=referral&utm_content=asciidoctor-lifecycle-maven/asciidoctor-lifecycle-maven-plugin&utm_campaign=Badge_Grade"]
