...
You will notice that the `asciidoctor-lifecycle@build` goal is not binded by default to the `asciidoctor@process-asciidoc` goal.
...
The defalut value is `${project.build.directory}/asciidoctor-themes`.
