...
public final class SettingsUtil {
     ...
     *
     * @param serverId
     *            the id of the server to look for credentials
     * @param settings
     *            the settings in settings.xml
     * @param settingsDecrypter
     *            a decrypter implementation of passwords stored in settings.xml
     * @return an object with the authentication info for that server or null if none founded
     */
    public static AuthenticationInfo getAuthenticationInfo(final String serverId, final Settings settings,
